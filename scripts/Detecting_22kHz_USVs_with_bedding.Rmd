...
```{r optimize detection for 22 kHz all cuts, eval = FALSE}
...
```{r optimizing detection for all 22 kHz cuts , eval = TRUE}
...
```{r random forest diagnostic, eval = FALSE}
# Final results
...
```{r random forest results plots, eval = FALSE}
 # Black line = 1:1
